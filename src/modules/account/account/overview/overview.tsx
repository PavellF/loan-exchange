...
const Overview = (props: OverviewProps) => {
  ...
  return (
    <PageHeader
      ...
      extra={[
        <Button className={classes.ButtonTop} key="2">{t.requestToWithdraw}</Button>,
        <Button className={classes.ButtonTop} key="1" type="primary">{t.refill}</Button>
      ]}>
      ...
      <div className={classes.ButtonsBottom}>
        <Button style={{marginRight: 9}} key="2">{t.requestToWithdraw}</Button>
